...
DEVICE_PATH := device/realme/superzoom
...
TARGET_KERNEL_SOURCE := kernel/realme/superzoom
TARGET_KERNEL_CONFIG := superzoom_defconfig
...
# Assert
TARGET_OTA_ASSERT_DEVICE := superzoom

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 83886080 # This is the maximum known partition size, but it can be higher, so we just omit it
